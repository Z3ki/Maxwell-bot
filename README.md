...
plugin_manager.py              Plugin loading/runtime
plugins/maxwell_extras/        Owner panel, rich replies, progress, guards, etc.
api/api_server.py              Dashboard/admin API
web/                           Dashboard frontend
doctor.py                      Install/config checker
easy-install.sh                Small friendly installer
install.sh                     Full Docker installer
.env.simple.example            Human-friendly config
