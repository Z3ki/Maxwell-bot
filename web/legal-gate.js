(function () {
  ...
  overlay.innerHTML =
    ...
    '<p class="legal-kicker">very early public testing</p>' +
    "<h2>Agree to use Maxwell</h2>" +
    "<p>The hosted bot and this site are experimental. Expect bugs, downtime, lost memory, usage limits, and possible paid access later. The software is MIT open source; these terms cover <em>this</em> hosted instance.</p>" +
